# Nestwell Merchant Center Re-Review Evidence Package
...
| Evidence area | Current verified state | Public or account location |
|---|---|---|
...
| Legal and customer contact | Shopify and Merchant Center align on the owner-confirmed legal business address: Rainbow Drive, Vaughan, Ontario, L4L 2K8. The public Contact page preserves residence privacy by identifying the Langstaff location only as the customer correspondence address. The legacy public email identity is being replaced with the owner-approved Nestwell addresses before this evidence can be relied on for a future review. | Shopify legal settings, Merchant Center business information, and `/contact` |
...
| Checkout | The live cart reaches Shopify Checkout without the former 404/password loop. | Live browser verification |
| Privacy | No personal phone number is published on the store or deliberately added to Merchant Center. | Public Contact page and Merchant business information |
| Measurement | GA4 `G-F0PM857JTW` is live on the storefront and connected through Shopify’s Google & YouTube channel. | Live head, GA4 Realtime, and Shopify app connection |

## Public Business-Model Explanation

The public About page explains that Nestwell is a Canadian online retail storefront. It describes product discovery, partner fulfilment, checkout, order support, shipping, returns, and the business contact path in factual, customer-readable language. It does not claim manufacturer affiliation, medical outcomes, guaranteed delivery, or unsupported product certification.

## Catalogue Claims Control

The reviewed live catalogue sample uses factual product descriptions and does not make treatment, diagnosis, cure, or guarantee claims. One item requires owner review before it is represented in any future Google product scope: **Handheld CES Device with Ear Clips**. Its current public copy includes a medical-advice disclaimer, but its source-origin handle contains sensitive wellness terms. Do not submit claims or category changes for it without confirmed intended-use and compliance documentation.

## Before the Next Review Is Requested
